import { criteriaError, decisionCandidates, drawCandidate, facetValues, monthJournal, restaurantText, shiftMonth, validMonth } from './discovery.js?v=2.8.0';
import { formatPrice, todayLocal } from './model.js?v=2.8.0';
