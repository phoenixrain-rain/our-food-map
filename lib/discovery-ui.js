import { criteriaError, decisionCandidates, drawCandidate, facetValues, monthJournal, restaurantText, shiftMonth, validMonth } from './discovery.js?v=2.5.1';
import { formatPrice, todayLocal } from './model.js?v=2.5.1';
