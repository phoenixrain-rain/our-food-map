import { safeImageURL } from './model.js?v=2.5.1';

// A viewer follows photo identities, never a stale index across async refreshes.
export class PhotoGallery {
  constructor({ getState, getEpoch, getRepository, isCloud, ownerName, updatePhoto, onError, toast }) {
    Object.assign(this, { getState, getEpoch, getRepository, isCloud, ownerName, updatePhoto, onError, toast });
  ...
  open(id) {
    ...
    this.root.classList.remove('hidden'); this.render(); this.closeButton.focus({ preventScroll: true });
  }
