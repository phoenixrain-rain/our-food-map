import { CORE_DIMS, formatPrice, formatScore, placeKey } from './model.js?v=2.9.0';
import { MAX_COMPARISON, comparisonPlaces, selectedPlaces, filterComparison, comparisonLeaders } from './comparison.js?v=2.9.0';
