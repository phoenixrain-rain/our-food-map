const CACHE_NAME = 'our-food-map-shell-v7';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './app.js?v=2.4.0',
  './styles.css?v=2.4.0',
  './vendor/supabase.js?v=2.4.0',
  './lib/model.js?v=2.4.0',
  './lib/photos.js?v=2.4.0',
  './lib/cloud.js?v=2.4.0',
  './lib/local-store.js?v=2.4.0',
  './lib/avatar.js?v=2.4.0',
  './lib/dom.js?v=2.4.0',
  './lib/discovery.js?v=2.4.0',
  './lib/discovery-ui.js?v=2.4.0',
