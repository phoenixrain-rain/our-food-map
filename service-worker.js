const CACHE_NAME = 'our-food-map-shell-v4';
const APP_SHELL = [
  './',
  './index.html',
  ...
  './app.js?v=2.1.0',
  './styles.css?v=2.1.0',
  './vendor/supabase.js?v=2.1.0',
  './lib/model.js?v=2.1.0',
  './lib/photos.js?v=2.1.0',
  './lib/cloud.js?v=2.1.0',
  './lib/local-store.js?v=2.1.0',
